...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  interfaz_principal:-new(@main,dialog('Proyector Integrador Diagnosticador De Efermedades de Golfish',
        size(1000,1000))),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  crea_interfaz_inicio:- new(@interfaz,dialog('Bienvenido al Diagnosticador de Enermedades de pez',
  size(1000,1000))),
